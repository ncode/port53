...
func TestZonedRoute_Create(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:               "valid input",
			input:              `{"data": {"id":"01F1ZQZJXQXZJXZJXZJXZJXZJX", "type": "zones", "attributes": {"name": "somethinsomething.martinez.io"}}}`,
			expectedData:       &model.Zone{ID: "01F1ZQZJXQXZJXZJXZJXZJXZJX", Name: "somethinsomething.martinez.io"},
